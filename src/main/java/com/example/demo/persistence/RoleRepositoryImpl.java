...
public class RoleRepositoryImpl  implements RoleRepository {
    ...
    @Override
    public Integer max() {
        return jdbcTemplate.queryForObject("select max(id) from role ",Integer.class);
    }
    ...
    public List<Role> getRoles(String userName) {
        return jdbcTemplate.query("select * from role r join user_roles ur on r.name=ur.roles where ur.username=?",BeanPropertyRowMapper.newInstance(Role.class),userName);
    }
}
